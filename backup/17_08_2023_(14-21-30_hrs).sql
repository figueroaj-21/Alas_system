...
) ENGINE=InnoDB AUTO_INCREMENT=154 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla de Auditoria';
...
INSERT INTO tbl_auditoria VALUES("131","cachapa_frita","2023-08-14","El usuario [cachapa_frita] inició sesión como usuario","","0");
INSERT INTO tbl_auditoria VALUES("132","cachapa_frita","2023-08-14","El usuario [cachapa_frita] inició sesión como usuario","","0");
INSERT INTO tbl_auditoria VALUES("133","cachapa_frita","2023-08-14","El usuario [cachapa_frita] inició sesión como usuario","","0");
INSERT INTO tbl_auditoria VALUES("134","cachapa_frita","2023-08-15","El usuario [cachapa_frita] generó un reporte general de Productos","","0");
INSERT INTO tbl_auditoria VALUES("135","cachapa_frita","2023-08-15","El usuario [cachapa_frita] generó un reporte general de Clasificaciones","","0");
INSERT INTO tbl_auditoria VALUES("136","cachapa_frita","2023-08-15","El usuario [cachapa_frita] generó un reporte general de Proveedores","","0");
INSERT INTO tbl_auditoria VALUES("137","cachapa_frita","2023-08-15","El usuario [cachapa_frita] generó un reporte general de Productos en Stock Minimo","","0");
INSERT INTO tbl_auditoria VALUES("138","cachapa_frita","2023-08-15","El usuario [cachapa_frita] generó un reporte general de Entrada de Productos por Periodo","","0");
INSERT INTO tbl_auditoria VALUES("139","cachapa_frita","2023-08-15","El usuario [cachapa_frita] generó un reporte general de Entrada de Productos por Periodo","","0");
INSERT INTO tbl_auditoria VALUES("140","cachapa_frita","2023-08-15","El usuario [cachapa_frita] generó un reporte general de Usuarios","","0");
INSERT INTO tbl_auditoria VALUES("141","cachapa_frita","2023-08-15","El usuario [cachapa_frita] generó un reporte general de Productos Inhabilitados","","0");
INSERT INTO tbl_auditoria VALUES("142","cachapa_frita","2023-08-15","El usuario [cachapa_frita] registró una salida del producto [glup cola 2lt]","","0");
INSERT INTO tbl_auditoria VALUES("143","cachapa_frita","2023-08-15","El usuario [cachapa_frita] registró al usuario [@figueroaj]","","0");
INSERT INTO tbl_auditoria VALUES("144","cachapa_frita","2023-08-15","El usuario [cachapa_frita] cerró sesión","","0");
INSERT INTO tbl_auditoria VALUES("145","@figueroaj","2023-08-15","El usuario [@figueroaj] inició sesión como usuario","","0");
INSERT INTO tbl_auditoria VALUES("146","@figueroaj","2023-08-15","El usuario [@figueroaj] cerró sesión","","0");
INSERT INTO tbl_auditoria VALUES("147","@figueroaj","2023-08-15","El usuario [@figueroaj] inició sesión como usuario","","0");
INSERT INTO tbl_auditoria VALUES("148","@figueroaj","2023-08-15","El usuario [@figueroaj] inició sesión como usuario","","0");
INSERT INTO tbl_auditoria VALUES("149","@figueroaj","2023-08-15","El usuario [@figueroaj] realizó un respaldo de la base de datos","","0");
INSERT INTO tbl_auditoria VALUES("150","@figueroaj","2023-08-15","El usuario [@figueroaj] cerró sesión","","0");
INSERT INTO tbl_auditoria VALUES("151","@figueroaj","2023-08-15","El usuario [@figueroaj] inició sesión como usuario","","0");
INSERT INTO tbl_auditoria VALUES("152","@figueroaj","2023-08-15","El usuario [@figueroaj] cerró sesión","","0");
INSERT INTO tbl_auditoria VALUES("153","@figueroaj","2023-08-17","El usuario [@figueroaj] inició sesión como usuario","","0");
...
INSERT INTO tbl_productos VALUES("1","001","glup cola 2lt","25","200","100","","1","1","1","41");
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla Salida';
...
INSERT INTO tbl_salida VALUES("8","2023-08-14","100","147852","1");
...
) ENGINE=InnoDB AUTO_INCREMENT=43 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Tabla de Usuarios';
...
INSERT INTO tbl_usuarios VALUES("42","@figueroaj","$2y$10$Y5xnTfBd/T2HHrQTHyiKqu.Yy0Z1I25P5u.wJk0voLUO5yMjuhZIK","12484336","Juan","Figueroa","figueroa@gmail.com","Maracay","2","1");
