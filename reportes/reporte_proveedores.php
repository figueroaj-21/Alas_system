...
$pdf->Write(5, utf8_decode('Reporte de Proveedores al ' . $fecha));
$pdf->Ln(25);
...
// Obtener la fecha actual
  ...
  $sql_aud = "INSERT INTO tbl_auditoria (usuario_aud, tiemporegistro_aud, accion_aud) VALUES ('$usuario', '$fecha', 'El usuario [$usuario] generó un reporte general de Proveedores')";
