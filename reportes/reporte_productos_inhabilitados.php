...
$resultado = mysqli_query($conexion, $sql_facturas) or die("Error al consultar productos inhabilitados: " . mysqli_error($conexion));
...
$pdf->Write(5, utf8_decode('Reporte de Productos Inhabilitados al ' . $fecha));
$pdf->Ln(25);
...
$pdf->Cell(40, 10, utf8_decode('Clasificación'), 1 , 0, 'C', 1);
...
$pdf->Cell(60, 10, utf8_decode('Proveedor'), 1, 0, 'C', 1);
$pdf->Ln();
...
// Obtener la fecha actual
  ...
  $sql_aud = "INSERT INTO tbl_auditoria (usuario_aud, tiemporegistro_aud, accion_aud) VALUES ('$usuario', '$fecha', 'El usuario [$usuario] generó un reporte general de Productos Inhabilitados')";
