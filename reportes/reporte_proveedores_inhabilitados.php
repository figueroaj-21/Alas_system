...
$pdf->Write(5, utf8_decode('Reporte de Proveedores Inhabilitados al ' . $fecha));
$pdf->Ln(25);
...
$pdf->SetTextColor(255, 255, 255);
$pdf->Cell(40, 10, utf8_decode('Rif del Proveedor'), 1, 0, 'C', 1);
$pdf->Cell(60, 10, utf8_decode('Nombre del Proveedor'), 1 , 0, 'C', 1);
$pdf->Cell(50, 10, utf8_decode('Numero del Proveedor'), 1, 0, 'C', 1);
$pdf->Cell(50, 10, utf8_decode('Persona de Contacto'), 1, 0, 'C', 1);
$pdf->Cell(70, 10, utf8_decode('Correo del Proveedor'), 1, 0, 'C', 1);
$pdf->Ln();
...
while ($row_factura = mysqli_fetch_array($resultado, MYSQLI_ASSOC)) {
    $pdf->Cell(40, 10, $row_factura['rif_proveedor'], 1, 0, 'C', 1);
    $pdf->Cell(60, 10, $row_factura['nombre_proveedor'], 1, 0, 'C', 1);
    $pdf->Cell(50, 10, $row_factura['numero_contacto'], 1, 0, 'C', 1);
    $pdf->Cell(50, 10, $row_factura['persona_contacto'], 1, 0, 'C', 1);
    $pdf->Cell(70, 10, $row_factura['correo_proveedor'], 1, 0, 'C', 1);
    $pdf->Ln();
}
...
// Obtener la fecha actual
  ...
  $sql_aud = "INSERT INTO tbl_auditoria (usuario_aud, tiemporegistro_aud, accion_aud) VALUES ('$usuario', '$fecha', 'El usuario [$usuario] generó un reporte general de Proveedores Inhabilitados')";
